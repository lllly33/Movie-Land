      ...
      <div class="cinema-container" v-if="cinemaInfo.length">
        ...
        <div class="item" v-for="(item,index) in cinemaInfo" :key="index" @click="$router.push({path:'/cinema_detail',query:{cinema_id:item.cinema_id}})">
          <div class="left">
            ...
            <div class="label-block"><span>海报赠送</span><span>映后分享</span><span>杜比全景声厅</span><span>IMAX GT</span></div>
          </div>
          <!--<div class="right">-->
        ...
        computed:{
          ruleName(){
            return (nameString)=>{
              ...
              let replaceString = `<span style="color: #5748A3">${this.name}</span>`;
