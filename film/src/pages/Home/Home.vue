        ...
        <div class="swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="./images/swiper/1.jpg" alt="" @click="$router.push({path:'/movie_detail',query:{movie_id:6}})">
            </div>
            <div class="swiper-slide">
              <img src="./images/swiper/2.png" alt="" @click="$router.push({path:'/movie_detail',query:{movie_id:7}})">
            </div>
            <div class="swiper-slide">
              <img src="./images/swiper/3.jpg" alt="" @click="$router.push({path:'/movie_detail',query:{movie_id:8}})">
            </div>
            <div class="swiper-slide">
              <img src="./images/swiper/4.jpg" alt="" @click="$router.push({path:'/movie_detail',query:{movie_id:9}})">
            </div>
          </div>
          <!-- 如果需要分页器 -->
